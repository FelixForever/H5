...
import org.kymjs.kjframe.widget.KJListViewFooter.LoadMoreState;
import org.kymjs.kjframe.widget.KJListViewHeader.RefreshState;
        ...
        mHeaderView.getViewTreeObserver().addOnGlobalLayoutListener(
                new OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        int tempHeight = mHeaderViewContent.getHeight();
                        if (tempHeight > 0) {
