    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childView.getVisibility() != View.GONE) {
               ...
               // childView.setBackgroundResource(R.drawable);
             /*   final float rotation = (childWidth < 0 ? 30f : -30f) * Math.abs(childWidth);
                childView.setTranslationX(getOffsetXForRotation(rotation, childView.getWidth(), childView.getHeight()));
                childView.setPivotX(childView.getWidth() * 0.5f);
                childView.setPivotY(0);
                childView.setRotationY(rotation);*/
